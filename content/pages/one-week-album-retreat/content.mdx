...
<ImageComp
  src={mixingSceneImage}
  className="w-full "
  alt="A mixer and a laptop, ready to record"
>
...
<ImageComp
  src={hannesOnPianoImage}
  className="w-full "
  alt="Hannes Diem playing on a grand piano"
>
...
<ImageComp
  src={hannesOnGuitarImage}
  className="w-full"
  alt="Hannes Diem playing Guitar in the sun"
>
...
<div className="flex content-center justify-center">
  <a href="mailto:album-retreat@hannesdiem.de" className={primaryButtonStyles}>Join us!</a>
</div>
